            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:searchParams.order.split(':')[0]==='1'}">
                  <a href="#" @click="handleAscOrDesc(1)">
                    综合
                    <i
                      v-if="searchParams.order.split(':')[0]==='1'"
                      class="iconfont"
                      :class="{'icon-down':searchParams.order.split(':')[1]==='asc','icon-up':searchParams.order.split(':')[1]==='desc'}"
                    ></i>
                  </a>
                </li>
                <li>
                ...
                <li :class="{active:searchParams.order.split(':')[0]==='2'}">
                  <a href="#" @click="handleAscOrDesc(2)">
                    价格
                    <i
...
export default {
  ...
  methods: {
    // 升序降序
    handleAscOrDesc (flag) {
      let synthesize = this.searchParams.order.split(':')[0]
      let sort = this.searchParams.order.split(':')[1]
      let newOrder
      if (flag == synthesize) {
        newOrder = `${flag}:${sort === 'asc' ? 'desc' : 'asc'}`
